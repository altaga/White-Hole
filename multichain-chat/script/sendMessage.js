...
async function main() {
	...
	const message = 'Hello from Avalanche to Polygon! Crosschain2';
	...
	const tx = await MessageSender.sendMessage(targetChain, targetAddress, gas_limit, to, messFrom, messTo, iv, ethers.utils.parseUnits("0", 6), {
		value: txCost,
	});
	...
	console.log(
		`You may see the transaction status on the Wormhole Explorer: https://wormholescan.io/#/tx/${tx.hash}`
	);
}
